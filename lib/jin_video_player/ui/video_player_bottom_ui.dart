...
import 'package:shijie/jin_video_player/ui/danmaku_setting_ui.dart';
import 'package:shijie/jin_video_player/ui/danmaku_source_setting_ui.dart';
import 'package:shijie/jin_video_player/ui/play_speed_ui.dart';
...
class _VideoPlayerBottomUIState extends State<VideoPlayerBottomUI> {
  ...
  /// 横屏底部UI
  Widget _buildHorizontalScreenBottomUI(VideoPlayerGetxController _) {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GetBuilder<VideoPlayerGetxController>(
                          id: UpdateId.showDanmakuBtn,
                          builder: (_) => IconButton(
                              onPressed: () {
                                _.videoPlayerParams.showDanmaku = !_.videoPlayerParams.showDanmaku;
                                _.update([UpdateId.showDanmakuBtn]);
                              },
                              icon: _.videoPlayerParams.showDanmaku
                                  ? const Icon(
                      ...
                      TextButton(
                        onPressed: () async {
                          _hideTimer?.cancel();
                          _.hideAllUI();
                          _.videoPlayerParams.showDanmakuSourceSetting?.call();
                          Get.dialog(
                              const Stack(
                                children: [
                                  Align(
                                    alignment: Alignment.centerRight,
                                    child: DanmakuSourceSettingUI(isFullScreen: true,),
                                  )
                                ],
                              ),
                      ...
                      IconButton(
                          onPressed: () {
                            _hideTimer?.cancel();
                            _.hideAllUI();
                            // _.videoPlayerParams.showDanmakuSetting?.call();
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: const Stack(
                                      children: [
                                        Align(
                                          alignment: Alignment.centerRight,
                                          child: DanmakuSettingUI(isFullScreen: true,),
                                        )
                                      ],
                                    ),
                                  ),
                          ...
                          Get.dialog(
                              const Stack(
                                children: [
                                  Align(
                                    alignment: Alignment.centerRight,
                                    child: PlaySpeedUI(isFullScreen: true,),
                                  )
                                ],
                              ),
                            barrierColor: Colors.white.withOpacity(0)
