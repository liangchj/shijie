...
class VideoPlayerGetxController extends GetxController {
  ...
  void changeShowPlaySpeedSettingState(bool flag) {
    bool haveChange = videoPlayerParams.showPlaySpeedSetting != flag;
    videoPlayerParams.showPlaySpeedSetting = flag;
    if (haveChange) {
      update([UpdateId.haveUIShow, UpdateId.playSpeedSetting]);
    }
  }
  /// 改变视频章节UI显示状态
  void changeShowVideoChapterListState(bool flag) {
    bool haveChange = videoPlayerParams.showVideoChapterList != flag;
    videoPlayerParams.showVideoChapterList = flag;
    if (haveChange) {
      update([UpdateId.haveUIShow, UpdateId.videoChapterList]);
    }
  }
  ...
  bool haveUIShow() {
    return videoPlayerParams.showTopUI ||
        ...
        videoPlayerParams.showPlaySpeedSetting  ||
        videoPlayerParams.showVideoChapterList ;
  }
  ...
  void hideAllUI() {
    ...
    if (videoPlayerParams.showPlaySpeedSetting) {
      updateIds.add(UpdateId.playSpeedSetting);
    }
    if (videoPlayerParams.showVideoChapterList) {
      updateIds.add(UpdateId.videoChapterList);
    }

    videoPlayerParams.showTopUI = false;
    videoPlayerParams.showCenterUI = false;
    videoPlayerParams.showBottomUI = false;
    videoPlayerParams.showPlaySpeedSetting = false;
    videoPlayerParams.showVideoChapterList = false;
    update(updateIds);
  }
